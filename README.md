...
# 0297springboot计算机学院校友网

![picture](https://raw.githubusercontent.com/GraduationProject-springboot/.github/main/img/wx.png)

### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1jqaLe1EbH?p=63)


# 第1章 绪论
## 1.1 课题背景
互联网发展至今，无论是其理论还是技术都已经成熟，而且它广泛参与在社会中的方方面面。它让信息都可以通过网络传播，搭配信息管理工具可以很好地为人们提供服务。所以各行业，尤其是规模较大的企业和学校等都开始借助互联网和软件工具管理信息，传播信息，共享信息等等，以此可以增强自身实力，提高在同行业当中的竞争能力，并从各种激烈的竞争中获取发展的机会。针对校友分会信息管理混乱，出错率高，信息安全性差，劳动强度大，费时费力等问题，经过分析和考虑，在目前的情况下，可以引进一款计算机学院校友网这样的现代化管理工具，这个工具就是解决上述问题的最好的解决方案。它不仅可以实时完成信息处理，还缩短校友分会信息管理流程，使其系统化和规范化。同时还可以减少工作量，节约校友分会信息管理需要的人力和资金。所以计算机学院校友网是信息管理环节中不可缺少的工具，它对管理者来说非常重要。
## 1.2 课题意义 
现如今，信息种类变得越来越多，信息的容量也变得越来越大，这就是信息时代的标志。近些年，计算机科学发展得也越来越快，而且软件开发技术也越来越成熟，因此，在生活中的各个领域，只要存在信息管理，几乎都有计算机的影子，可以说很多行业都采用计算机的方式管理信息。信息计算机化处理相比手工操作，有着保密性强，效率高，存储空间大，成本低等诸多优点。针对校友分会信息管理，采用计算机学院校友网可以有效管理，使信息管理能够更加科学和规范。

总之，在实际中使用计算机学院校友网，其意义如下：

第一点：计算机学院校友网的实际运用，可以帮助管理人员在短时间内完成信息处理工作；
...
第四点：可以降低信息管理成本；
## 1.3 研究内容
对计算机学院校友网设计制作，不仅需要技术支撑，也需要大量的理论研究。本文在对计算机学院校友网进行介绍时，将按照如下内容进行。

第一部分：介绍计算机学院校友网研究的背景意义，便于用户了解系统；

第二部分：介绍开发计算机学院校友网需要搭建的环境，包括技术和工具；

第三部分：介绍用户对计算机学院校友网的功能要求，以及对计算机学院校友网的性能要求等；
...
# 第2章 开发环境与技术
计算机学院校友网的编码实现需要搭建一定的环境和使用相应的技术，接下来的内容就是对计算机学院校友网用到的技术和工具进行介绍。
## 2.1 MYSQL数据库
...
### 3.1.2 经济可行性
本系统开发期间需要配置的软件环境，可以免费通过开发类官网下载安装，需要配置的硬件设备也不需要具备很高的性能，通常网吧电脑，或学校计算机机房的电脑都符合要求。因此，从经济方面考虑，计算机学院校友网开发可行。
### 3.1.3 操作可行性
计算机学院校友网根据用户使用习惯进行开发，设计的界面具有统一性，并具备优秀的导航功能。所以，只要会简单操作电脑的人员，可以无压力操作计算机学院校友网。
...
## 4.2 功能结构设计
在前面分析的管理员功能的基础上，进行接下来的设计工作，最终展示设计的管理员结构图（见下图）。管理员增删改查校友分会
...
![C:\Users\Administrator\Desktop\img\xiaoyouwang\校友风采.jpg](/md/blog.006.jpeg "C:\Users\Administrator\Desktop\img\xiaoyouwang\校友风采.jpg")
图4.1 校友风采实体属性图

（2）下图是分会成员实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\xiaoyouwang\分会成员.jpg](/md/blog.007.jpeg "C:\Users\Administrator\Desktop\img\xiaoyouwang\分会成员.jpg")
图4.2 分会成员实体属性图

（3）下图是校友交谈实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\xiaoyouwang\校友交谈.jpg](/md/blog.008.jpeg "C:\Users\Administrator\Desktop\img\xiaoyouwang\校友交谈.jpg")
图4.3 校友交谈实体属性图

（4）下图是校友分会实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\xiaoyouwang\校友分会.jpg](/md/blog.009.jpeg "C:\Users\Administrator\Desktop\img\xiaoyouwang\校友分会.jpg")
图4.4 校友分会实体属性图

（5）下图是公告信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\xiaoyouwang\公告信息.jpg](/md/blog.010.jpeg "C:\Users\Administrator\Desktop\img\xiaoyouwang\公告信息.jpg")
图4.5 公告信息实体属性图

（6）下图是字典表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\xiaoyouwang\字典表.jpg](/md/blog.011.jpeg "C:\Users\Administrator\Desktop\img\xiaoyouwang\字典表.jpg")
图4.6 字典表实体属性图

（7）下图是校友实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\xiaoyouwang\校友.jpg](/md/blog.012.jpeg "C:\Users\Administrator\Desktop\img\xiaoyouwang\校友.jpg")
图4.7 校友实体属性图

（8）下图是活动发布实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\xiaoyouwang\活动发布.jpg](/md/blog.013.jpeg "C:\Users\Administrator\Desktop\img\xiaoyouwang\活动发布.jpg")
图4.8 活动发布实体属性图

（9）下图是校友招聘实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\xiaoyouwang\校友招聘.jpg](/md/blog.014.jpeg "C:\Users\Administrator\Desktop\img\xiaoyouwang\校友招聘.jpg")
图4.9 校友招聘实体属性图

（10）下图是用户表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\xiaoyouwang\用户表.jpg](/md/blog.015.jpeg "C:\Users\Administrator\Desktop\img\xiaoyouwang\用户表.jpg")
图4.10 用户表实体属性图
### 4.3.2 数据库物理设计
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|xiaoyoufenhui\_id|Integer|分会名称|是|
|3|chengyuan\_name|String|成员名称|是|
|4|chengyuan\_photo|String|成员头像|是|
|5|sex\_types|String|性别|是|
|6|chengyuan\_phone|String|联系方式|是|
...
|1|Id|Int|id|否|
|2|yonghu\_id|Integer|校友|是|
|3|xiaoyoufengcai\_name|String|标题|是|
|4|xiaoyoufengcai\_types|Integer|奖项类型|是|
|5|xiaoyoufengcai\_photo|String|封面|是|
|6|xiaoyoufengcai\_jiango|String|所得奖项|是|
|7|xiaoyoufengcai\_content|String|详情|是|
|8|create\_time|Date|创建时间|是|
表4.7校友分会表
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|xiaoyoufenhui\_name|String|分会名称|是|
|3|xiaoyoufenhui\_types|Integer|分会类型|是|
|4|xiaoyoufenhui\_photo|String|分会封面|是|
|5|xiaoyoufenhui\_fuzheren|String|负责人|是|
|6|xiaoyoufenhui\_address|String|分会地点|是|
|7|xiaoyoufenhui\_content|String|分会简介|是|
|8|create\_time|Date|创建时间|是|
表4.8校友表
...
|11|zhaopin\_content|String|招聘信息详情|是|
